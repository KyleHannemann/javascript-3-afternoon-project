...
//Code Here
for (var number in deleteTheBigNumbers){
  if (deleteTheBigNumbers[number] > 100){
    delete deleteTheBigNumbers[number];
  }
}
...
function hiddenTreasure(obj){
  for (var sent in obj){
     var checkk = obj[sent];
     if (checkk.includes("treasure") != true){
       delete obj[sent];
     }
